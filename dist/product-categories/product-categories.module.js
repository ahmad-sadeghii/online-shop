...
const product_categories_resolver_1 = require("./product-categories.resolver");
...
exports.ProductCategoriesModule = ProductCategoriesModule = __decorate([
    (0, common_1.Module)({
        providers: [product_categories_resolver_1.ProductCategoriesResolver, product_categories_service_1.ProductCategoriesService],
    })
